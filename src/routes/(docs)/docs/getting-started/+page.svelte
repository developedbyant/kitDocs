...
<h1 data-section data-sb="header" id="getting-started">
    Getting started
</h1>
<p data-sb="p">After installing kitDocs you will need to do the following:</p>
<ul data-sb="list">
    <li>Add <code data-sb="inline-code">src</code> alias to svelte.config.js</li>
    <li>Add the markdown to svelte plugin</li>
    <li>create pages (routes)</li>
</ul>
<div data-sb="space"></div>
<h2 data-section data-sb="header" id="adding-alias">
    Adding alias
</h2>
<p data-sb="p">Inside <code data-sb="inline-code">svelte.config.js</code> add the src alias needed for kitDocs to work.</p>
...
<div data-sb="space"></div>
<h2 data-section data-sb="header" id="add-plugin">
    Add plugin
</h2>
<p data-sb="p">In order to convert your markdown files to svelte pages, you needed to add kitDocs plugin from 
<code data-sb="inline-code">src/kitDocs/lib/plugin</code> to the <code data-sb="inline-code">vite.config.ts</code> file.</p>
...
<div data-sb="space"></div>
<h2 data-section data-sb="header" id="create-pages-folder">
    Create pages folder
</h2>
<p data-sb="p">To create a route/page create a folder named <code data-sb="inline-code">pages</code> in your working directory, 
...
<p data-sb="p">All markdown files most have the following keys on top of the files.</p>
<ul data-sb="list">
